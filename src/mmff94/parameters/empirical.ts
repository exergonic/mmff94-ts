...
// Scope: the plain form is validated on BOij = 1 single bonds only (the
// suite's one empirical bond); the paper's δ/BOij/hybridization reductions for
// multiple and aromatic bonds are NOT implemented.
//
// The finding in one line: Part V's eq. (18) includes a δ shrinkage;
// Halgren's own reference implementation does not apply it, and the
// 753-molecule validation suite (generated by BatchMin) reflects that —
// this library matches the reference implementation, not the literal
// published equation, on this point. See docs/implementer-notes.md §4.1.
//
