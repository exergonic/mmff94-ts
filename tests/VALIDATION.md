...
fresh from `mmff94-atom-types.json`). Snapshot 2026-08-01:

| term | \|Δ\|≤0.05 | mean\|Δ\| | max\|Δ\| | worst |
|---|---|---|---|---|
| bond | 64/65 | 0.397 | 25.80 | JIYJAC +25.80 |
| angle | 63/65 | 1.469 | 88.94 | FAGVEO +88.94, JIYJAC +6.53 |
| strbnd | 23/65 | 0.885 | 11.86 | CUDNEU +11.86, VEYBIK +5.85, FINBIN +5.22 |
| torsion | 49/65 | 0.315 | 4.92 | FUVDOP −4.92, JIYJAC −3.21, FOWZAS +3.11 |
| vdw | 52/65 | 0.084 | 1.38 | DUYNOA +1.38, DIKWID +1.18, GEKXEZ +0.94 |
...
are term bugs by construction. Open diagnosis threads: FAGVEO's angle
(+88.94 — near-linear/eq-4 suspect), JIYJAC (bond +25.80), CUDNEU
strbnd (+11.86 — eq-4 interplay), FUVDOP torsion (−4.92), DUYNOA vdw
(+1.38). OOP is exact on all 65.
